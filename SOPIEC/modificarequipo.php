        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div id="page-inner">
                    ...
                    <form  id="formActualizarEquipo" class="form-nuevo-cliente" action="assets/php/actualizarequipo.php" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <option selected  value="<?php echo $marca ?>" id="marca"> Actual: <?php echo $marca ?></option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="nombre" name="nombre" placeholder="DESKTOP-XXXCCXZXC" require require value="<?php echo $nombre ?>">
                            </div>
                            <!-- tIPO EQUIPO -->
                            <div class="form-group col-md-6">
                                <label for="registrar-segundo-nombre">Tipo equipo</label>
                                <select class="form-control"name="tipo_equipo" id="tipo_equipo" require>
                                  <option selected value="<?php echo $tipo_equipo ?>" id="tipo_equipo"> Actual: <?php echo $tipo_equipo ?></option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="modelo_equipo" name="modelo_equipo" placeholder="123123XXXXXX" require value="<?php echo $modelo_equipo ?>">
                            </div>
                            <!-- procesador -->
                            <div class="form-group col-md-6">
                                <label for="registrar-segundo-apellido">Procesador</label>
                                <input type="text" class="form-control" id="procesador" name="procesador" placeholder="Casas" require value="<?php echo $procesador ?>">
                            </div>
                            <!-- Memoria Ram -->
                            <div class="form-group col-md-6">
                                <label for="registrar-email">Ram</label>
                                <input type="text" class="form-control" id="ram" name="ram" placeholder="Xgb ram tipo X" require value="<?php echo $ram ?>">
                            </div>
                            <!-- Disco Duro -->
                            <div class="form-group col-md-6">
                                <label for="registrar-contrasena">Disco_duro</label>
                                <input type="text" class="form-control" id="disco_duro" name="disco_duro" placeholder="marca del disco duro" require value="<?php echo $disco_duro ?>" >
                            </div>
                            <!-- Sistema operativo-->
                            <div class="form-group col-md-6">
                                ...
                                <option selected value="<?php echo $sistema_operativo ?>" id="sistme_operativo"> Actual: <?php echo $sistema_operativo?> </option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <option selected value="<?php echo $estado ?>" id="sistme_operativo"> Actual: <?php echo $estado?> </option>
                        ...
                        <button type="submit" class="btn btn-success btn-lg r" name="actualizarEquipo" value="actualizarEquipo" id="actualizarEquipo">Actualizar</button>
