            ...
            <div id="page-inner">
                ...
                <div class="mostrar-datos">
                    ...
                    <div class="col-lg-3 well caja-mostrar-datos" style="margin-top: 20px;">
                        ...
                        <center>
                            <button id="asignar" data-toggle="modal" data-target="#staticBackdrop" href="modal" class="btn btn-success btn-lg r" name="modificarUser" style="border-radius: 5px !important;">Actualizar mis datos</button></center>
                    </div>
                    ...
                    <div class="col-lg-3 well col-md-offset-1 caja-mostrar-datos" style="margin-top: 20px;">
                        ...
                        <form method="POST" id="cambiarContrasena" name="cambiarContrasena" action="assets/php/actualizarDatosUser.php">
                            ...
                            <div class="modal-footer">
                                <center>
                                    <button type="submit" class="btn btn-primary btn-lg r" name="cambiarContrasena">Actualizar mi
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="actualizarDatos" name="actualizarDatos" action="assets/php/actualizarDatosUser.php">
                                        <div class="form-row">
                                            <!-- Cedula de ciudadania -->
                                            <div class="form-group col-md-6">
                                                <label for="registrar-primer-nombre">Cedula de ciudadania</label>
                                                <input type="number" class="form-control" id="cedula" name="cedula" placeholder="112223344556" require value="<?php echo $reg['cedula'] ?>" readonly>
                                            </div>
                                            <!-- Area de trabajo -->
                                            <div class="form-group col-md-6">
                                                <label for="registrar-segundo-nombre">Area de trabajo</label>
                                                <input type="number" class="form-control" id="area" name="area" placeholder="5" require value="<?php echo $reg['area'] ?>">
                                            </div>
                                            <!-- Primer nombre -->
                                            <div class="form-group col-md-6">
                                                <label for="registrar-primer-nombre">Primer nombre</label>
                                                <input type="text" class="form-control" id="primer_nombre" name="primer_nombre" placeholder="Andrés" require value="<?php echo $reg['primer_nombre'] ?>">
                                            </div>
                                            <!-- Segundo nombre -->
                                            <div class="form-group col-md-6">
                                                <label for="registrar-segundo-nombre">Segundo nombre</label>
                                                <input type="text" class="form-control" id="segundo_nombre" name="segundo_nombre" placeholder="José" value="<?php echo $reg['segundo_nombre']  ?>">
                                            </div>
                                            <!-- Primer apellido -->
                                            <div class="form-group col-md-6">
                                                <label for="registrar-primer-apellido">Primer apellido</label>
                                                <input type="text" class="form-control" id="primer_apellido" name="primer_apellido" placeholder="Salas" require value="<?php echo $reg['primer_apellido'] ?>">
                                            </div>
                                            <!-- Segundo apellido -->
                                            <div class="form-group col-md-6">
                                                <label for="registrar-segundo-apellido">Segundo apellido</label>
                                                <input type="text" class="form-control" id="segundo_apellido" name="segundo_apellido" placeholder="Casas" value="<?php echo $reg['segundo_apellido'] ?>">
                                            </div>
                                            <!-- Email -->
                                            <div class="form-group col-md-6">
                                                <label for="registrar-email">Email</label>
                                                <input type="email" class="form-control" id="email" name="email" placeholder="correo_143@correo.com" require value="<?php echo $reg['email'] ?>">
                                                <!-- Div de carga -->
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="alert alert-warning" role="alert">
                                                    Este campo es obligatorio para efecuar los
                                                    cambios.</div>
                                                <input type="password" class="form-control" id="contrasenaActual" name="contrasenaActual" placeholder="*********" require value="" style="margin-bottom: 1rem;">
                                            </div>
                                        </div>
                                        <!-- Botones -->
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                                            <input type="submit" class="btn btn-primary" value="Actualizar datos" name="actualizarDatosUser">
                                        </div>
                                    </form>
