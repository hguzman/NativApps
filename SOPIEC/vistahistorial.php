                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12 text-center">
                                                <a href="historialdetickets.php" class="btn btn-primary btn-lg r">Regresar</a>
                                                <a href="verticket.php?id=<?php echo $reg['id']; ?>" class="btn btn-primary btn-lg r" >Editar</a>
                                            </div>
                                            </div>
